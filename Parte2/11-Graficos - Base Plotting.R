...
# png
png("Grafico1.png", width = 500, height = 500, res = 72) # abre o arquivo png
...
par(mfrow = c(1,1), col.axis = "red") # alterando parametros dos plots
plot(1:6, las = 3, xlab = "lty 1:6", ylab = "", main = "Mais opções ao plot")
ablineclip(v=1, lty=1, col="sienna2", lwd=2) # desenha linhas em casa elemento
