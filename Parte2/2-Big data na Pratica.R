...
cidadesBrasil <- na.omit(cidadesBrasil) # remove os valores NA
head(cidadesBrasil)
nrow(df)
nrow(cidadesBrasil)
dim(cidadesBrasil)
...
cidadesBrasil$dt <- as.POSIXct(cidadesBrasil$dt,format='%Y-%m-%d') # convertendo para data para objeto datetime
